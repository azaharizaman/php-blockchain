...
#### `estimateGas(array $transaction): int`
...
```bash
# Run all tests
vendor/bin/phpunit tests/Drivers/{{driver_name}}DriverTest.php

# Run with coverage
vendor/bin/phpunit --coverage-html coverage tests/Drivers/{{driver_name}}DriverTest.php
```
